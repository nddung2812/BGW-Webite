              ...
              <div className="scroll-section">
                <div className="scroll-img-ctn carousel-cnw">
                  <a target="_blank" href="https://shop.cnw.com.au/" >
                    <img src={PhotoArray[0]} alt="CNW Electrical"/>
                  </a>
                </div>
              ...
              <div className="scroll-section">
                <div className="scroll-img-ctn carousel-sherriff">
                  <a target="_blank" href="https://shop.sherriff.com.au/">
                    <img src={PhotoArray[2]} alt="Sherriff Electrical"/>
                  </a>
                </div>
                <div className="scroll-intro-snippet">
                  <h2>Sherriff</h2>
              ...
              <div className="scroll-section">
                <div className="scroll-img-ctn carousel-samios">
                  <a target="_blank" href="https://shop.samios.net.au/">
                    <img src={PhotoArray[1]} alt="Samios Plumbing"/>
                  </a>
                </div>
                <div className="scroll-intro-snippet">
                  <h2>Samios</h2>
              ...
              <div className="scroll-section">
                <div className="scroll-img-ctn carousel-sherriff">
                  <a target="_blank" href="https://wea-asia.com/">
                    <img src={PhotoArray[3]} alt="WEA Electrical"/>
                  </a>
                </div>
                <div className="scroll-intro-snippet">
