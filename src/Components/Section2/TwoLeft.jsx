      ...
      >
		...
		<div className="line-2">
			...
			<div className="block">
				...
				<div className="text-hl-ctn">
					<div className="hl-top">1,400+</div>
		...
		<div className="line-3">
			<div className="block">
				...
				<div className="text-hl-ctn">
					<div className="hl-top">15,000+</div>
					<div className="hl-text">Suppliers Domestically and Internationally</div>
				</div>
				</div>
			<div className="block">
				...
				<div className="text-hl-ctn">
					...
					<div className="hl-text">Privately Owned Businesses in Australia</div>
				</div>
				</div>
			<div className="block">
				<FontAwesomeIcon icon={faBusinessTime} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
					<div className="hl-top">1972</div>
		...
		<div className="line-1">
			<div className="block">
				<FontAwesomeIcon icon={faFile} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
					<div className="hl-text">Documentation and Reporting</div>
				</div>
			</div>
			<div className="block">
				<FontAwesomeIcon icon={faCalendarCheck} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
		...
		<div className="line-2">
			<div className="block">
				<FontAwesomeIcon icon={faTruck} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
			...
			<div className="block">
				<FontAwesomeIcon icon={faListCheck} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
		...
		<div className="line-3">
			<div className="block">
				<FontAwesomeIcon icon={faPhoneVolume} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
					<div className="hl-text">Customer Service</div>
				</div>
				</div>
			<div className="block">
				<FontAwesomeIcon icon={faSearchPlus} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
					<div className="hl-text">Progress Visibility</div>
				</div>
				</div>
			<div className="block">
				<FontAwesomeIcon icon={faCheckDouble} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
		...
		<div className="line-1">
			<div className="block">
				<FontAwesomeIcon icon={faChartColumn} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
					<div className="hl-text">Materials Management</div>
				</div>
			</div>
			<div className="block">
				<FontAwesomeIcon icon={faUserLock} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
						<div className="hl-text">Digital Procurement</div>
				</div>
			</div>
			<div className="block">
				<FontAwesomeIcon icon={faCartFlatbedSuitcase} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
		...
		<div className="line-2">
			<div className="block">
				<FontAwesomeIcon icon={faChargingStation} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
			...
			<div className="block">
				<FontAwesomeIcon icon={faCheckSquare} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
		...
		<div className="line-3">
			<div className="block">
				<FontAwesomeIcon icon={	faHandshakeAngle } className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
			...
			<div className="block">
				<FontAwesomeIcon icon={faScrewdriverWrench} className="cube-icon" color="#d13939" />
				<div className="text-hl-ctn">
